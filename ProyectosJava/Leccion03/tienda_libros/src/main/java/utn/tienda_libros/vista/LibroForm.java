...
public class LibroForm extends JFrame {
    ...
    private void modificar(Libro libro, String nombreColumna, int fila, int columna) {
        var valorCelda = tablaLibros.getValueAt(fila, columna);

        switch (nombreColumna) {
            case "Libro" -> {
                libro.setNombreLibro(valorCelda.toString());
            }
            case "Autor" -> {
                libro.setAutor(valorCelda.toString());
            }
            case "Precio" -> {
                libro.setPrecio(Double.parseDouble(valorCelda.toString()));
            }
            case "Existencias" -> {
                libro.setExistencias(Integer.parseInt(valorCelda.toString()));
            }
        }
